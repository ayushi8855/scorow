import { Box, Button, ButtonGroup, FormControl, FormLabel, Input, Popover, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverFooter, PopoverHeader, PopoverTrigger, Select, useDisclosure} from '@chakra-ui/react'
...
const Product = () => {
  ...
  return (
    ...
    >
      ...
      <Box border={"2px solid #ECECEC"} w={"50%"} m={2} p={3} borderStyle="dashed" >
